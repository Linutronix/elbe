...
from elbepack.buildsubmitaction import add_submit_arguments, resolve_input, xml_or_iso_file
...
def _build(args):
    ...
    local_build_with_repodir_and_dl_result(resolved.xmlfile, resolved.cdrom, args.base_image, args)
