...
If using ELBE from git repository directly, you'll need following packages installed:
    ...
    apt install python python-debian python-mako python-lxml python-apt python-gpg python-pyme python-suds python-libvirt qemu-utils qemu-kvm p7zip-full make
