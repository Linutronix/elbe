...
takes a long time to build an image and related artifacts (e.g. sdk),
...
Such a build directory can be produced using the standard ``elbe initvm submit``
procedure::

  $ ./elbe initvm submit tests/simple-validation-image.xml

or to build an extended image using the base image output::

  $ ./elbe initvm submit --base-image ./elbe-build-20260903-110523/base-rootfs.tgz tests/base-extended/simple-validation/image-extended.xml
